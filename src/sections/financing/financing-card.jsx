...
export default function FinancingCard({ id, name, cash, click, devices_count, manual, isLoading }) {
      ...
      <Card variant="outlined" sx={{ maxHeight: '265px', minWidth: '275px' }}>
        ...
        <CardActions>
          <Button sx={{ mx: 'auto' }} type="submit">
            <Link style={{ textDecoration: 'none', color: 'blue' }} to={`/financing/filial/${id}`}>
              Batafsil ma'lumot
            </Link>
          </Button>
        </CardActions>
